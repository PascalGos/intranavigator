...
class __$$_SuccessCopyWithImpl<$Res>
    extends _$ProductListStateCopyWithImpl<$Res, _$_Success>
...
class _$_Success implements _Success {
  const _$_Success({required final List<Product> items}) : _items = items;
...
abstract class _Success implements ProductListState {
  const factory _Success({required final List<Product> items}) = _$_Success;
