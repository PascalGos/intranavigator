...
import 'package:intranavigator/data/services/device_permission_service_impl.dart'
    as _i9;
import 'package:intranavigator/dependency_injection.dart' as _i47;
...
import 'package:intranavigator/domain/usecases/shopping_list/load_shopping_list_items.dart'
    as _i40;
import 'package:intranavigator/presentation/features/app/app.dart' as _i45;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i11.LoadDeviceInfoUseCase>(
        () => _i11.LoadDeviceInfoUseCase(service: gh<_i8.DeviceInfoService>()));
    gh.lazySingleton<_i12.LoadDevicePermissionsUseCase>(() =>
        _i12.LoadDevicePermissionsUseCase(
    ...
    gh.factory<_i20.ProductRemoteDataSource>(
        () => _i21.ProductRemoteDataSourceImpl(gh<_i10.FirebaseFirestore>()));
    ...
    gh.factory<_i33.AppBloc>(() => _i33.AppBloc(
          loadDeviceInfoUsecase: gh<_i11.LoadDeviceInfoUseCase>(),
          loadDevicePermissionsUsecase: gh<_i12.LoadDevicePermissionsUseCase>(),
        ));
    gh.factory<_i34.BluetoothBeaconInfoRemoteDataSource>(() =>
        _i35.BluetoothBeaconInfoRemoteDataSourceImpl(
            gh<_i10.FirebaseFirestore>()));
    gh.lazySingleton<_i36.BluetoothBeaconInfoRepository>(() =>
        _i37.DataBluetoothBeaconInfoRepositoryImpl(
            gh<_i34.BluetoothBeaconInfoRemoteDataSource>()));
    gh.lazySingleton<_i38.LoadAllProductCategoriesUseCase>(() =>
        _i38.LoadAllProductCategoriesUseCase(
            repository: gh<_i17.ProductCategoryRepository>()));
    gh.lazySingleton<_i39.LoadAllProductsUseCase>(() =>
        _i39.LoadAllProductsUseCase(repository: gh<_i22.ProductRepository>()));
    gh.lazySingleton<_i40.LoadShoppingListItemsUseCase>(() =>
        _i40.LoadShoppingListItemsUseCase(
            repository: gh<_i28.ShoppingListItemRepository>()));
    gh.factory<_i41.ProductCategoryListBloc>(() => _i41.ProductCategoryListBloc(
        gh<_i38.LoadAllProductCategoriesUseCase>()));
    gh.factory<_i42.ProductListBloc>(() => _i42.ProductListBloc(
        loadAllProductsUsecase: gh<_i39.LoadAllProductsUseCase>()));
    gh.factory<_i43.ProductTileBloc>(() => _i43.ProductTileBloc(
        addToShoppingListUseCase: gh<_i32.AddProductToShoppingListUseCase>()));
    gh.factory<_i44.SettingsBloc>(() => _i44.SettingsBloc(
          appBloc: gh<_i45.AppBloc>(),
          loadAppSettingsUseCase: gh<_i11.LoadDeviceInfoUseCase>(),
        ));
    gh.factory<_i46.ShoppingListBloc>(() => _i46.ShoppingListBloc(
        loadShoppingListItemsUsecase: gh<_i40.LoadShoppingListItemsUseCase>()));
    return this;
  }
}
...
class _$ExternalModule extends _i47.ExternalModule {}
