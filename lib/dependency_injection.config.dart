...
import 'package:flutter_web_bluetooth/flutter_web_bluetooth.dart' as _i13;
...
import 'package:intranavigator/data/services/device_permission_service_impl.dart'
    as _i9;
import 'package:intranavigator/dependency_injection.dart' as _i67;
...
import 'package:intranavigator/domain/services/device_permission_service.dart'
    as _i30;
import 'package:intranavigator/domain/services/services.dart' as _i8;
...
import 'package:intranavigator/domain/usecases/shopping_list/load_shopping_list_items.dart'
    as _i61;
import 'package:intranavigator/domain/usecases/user_managment/get_user.dart'
    as _i56;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i7.DevicePermissionLocalDatasource>(
        () => dataSources.localDevicePermissionDataSource);
    gh.lazySingleton<_i8.DevicePermissionService>(() =>
        _i9.DevicePermissionServiceImpl(
            localDatasource: gh<_i10.DevicePermissionLocalDatasource>()));
    gh.singleton<_i11.FirebaseFirestore>(externalModule.mockFirebaseFirestore);
    gh.lazySingleton<_i12.FlutterBluePlus>(
        () => externalModule.mobileBluetoothHandler);
    gh.lazySingleton<_i13.FlutterWebBluetoothInterface>(
        () => externalModule.webBluetoothHandler);
    gh.factory<_i14.GeoLocationLocalDataSource>(
        () => _i15.GeoLocationLocalDataSourceImpl());
    gh.lazySingleton<_i16.LoadDevicePermissionsUseCase>(() =>
        _i16.LoadDevicePermissionsUseCase(
            service: gh<_i8.DevicePermissionService>()));
    gh.lazySingleton<_i17.LocationRepository>(
        () => _i18.DataLocationRepositoryImpl());
    gh.factory<_i19.MainNavigationBloc>(() => _i19.MainNavigationBloc());
    gh.factory<_i20.OnboardingBloc>(() => _i20.OnboardingBloc());
    gh.lazySingleton<_i21.ProductCategoryRepository>(
        () => _i22.DataProductCategoryRepositoryImpl());
    gh.factory<_i23.ProductLocalizationBloc>(
        () => _i23.ProductLocalizationBloc());
    gh.factory<_i24.ProductRemoteDataSource>(
        () => _i25.ProductRemoteDataSourceImpl(gh<_i11.FirebaseFirestore>()));
    ...
    gh.factory<_i32.SettingsBloc>(() => _i32.SettingsBloc(
        requestPermissionUseCase: gh<_i29.RequestPermissionUseCase>()));
    ...
    gh.factory<_i39.UserRemoteDataSource>(() => _i40.UserRemoteDataSourceImpl(
        remoteDataSource: gh<_i11.FirebaseFirestore>()));
    ...
    gh.factory<_i44.BluetoothBeaconRemoteDataSource>(() =>
        _i45.BluetoothBeaconRemoteDataSourceImpl(gh<_i11.FirebaseFirestore>()));
    ...
    gh.factory<_i51.DeviceInfoLocalDataSource>(
        () => _i52.DeviceInfoLocalDataSourceImpl(gh<_i6.DeviceInfoPlugin>()));
    ...
    gh.lazySingleton<_i60.LoadDeviceInfoUseCase>(
        () => _i60.LoadDeviceInfoUseCase(service: gh<_i8.DeviceInfoService>()));
    ...
    gh.factory<_i62.ProductCategoryListBloc>(() => _i62.ProductCategoryListBloc(
        gh<_i58.LoadAllProductCategoriesUseCase>()));
    gh.factory<_i63.ProductListBloc>(() => _i63.ProductListBloc(
        loadAllProductsUsecase: gh<_i59.LoadAllProductsUseCase>()));
    gh.factory<_i64.ProductTileBloc>(() => _i64.ProductTileBloc(
        addToShoppingListUseCase: gh<_i43.AddProductToShoppingListUseCase>()));
    gh.factory<_i65.ShoppingListBloc>(() => _i65.ShoppingListBloc(
    ...
    gh.factory<_i66.AppBloc>(() => _i66.AppBloc(
          getUserUseCase: gh<_i56.GetUserUseCase>(),
          loadDeviceInfoUsecase: gh<_i60.LoadDeviceInfoUseCase>(),
          loadDevicePermissionsUsecase: gh<_i16.LoadDevicePermissionsUseCase>(),
          listenBluetoothConnectionUseCase:
              gh<_i57.ListenBluetoothConnectionUseCase>(),
        ));
    return this;
  }
}

class _$RouterModule extends _i67.RouterModule {}

class _$DataSources extends _i67.DataSources {}

class _$ExternalModule extends _i67.ExternalModule {}
