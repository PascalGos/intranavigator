...
class ShoppingListBloc extends Bloc<ShoppingListEvent, ShoppingListState> {
  ShoppingListBloc(
      {required LoadShoppingListItems loadShoppingListItemsUsecase})
      : _loadItems = loadShoppingListItemsUsecase,
        super(const _Initial()) {
    on<Started>(_onStarted);
  }

  late final LoadShoppingListItems _loadItems;
  ...
  Future<void> _onStarted(
    ...
    emit(const _Loading());
    final failureOrShoppingItemList = await _loadItems(NoParams());
